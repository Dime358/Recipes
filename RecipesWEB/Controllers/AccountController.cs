            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Send an email with this link
                     ...
                     await this.UserManager.AddToRoleAsync(user.Id, "RegisteredUser");
                    //return View("DisplayEmail");
                    //return RedirectToAction("Index", "Home");

                    return RedirectToAction("createRating", "Ratings", new { userId = user.Id , type = "user" });
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //return RedirectToLocal(returnUrl);
                        return RedirectToAction("createRating", "Ratings", new { userId = user.Id });
                    }
                }
                AddErrors(result);
            }
